...
public class MatchesAllStringValuePattern extends StringValuePattern {

    private final List<StringValuePattern> patterns;

    public MatchesAllStringValuePattern(@JsonProperty("matchesAll") List<StringValuePattern> patterns) {
        super("[" + String.join(" and ", Lists.transform(patterns, new Function<StringValuePattern, String>() {
            @Override
